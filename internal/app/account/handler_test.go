...
func (s *handlerService) Create(context.Context, uuid.UUID, CreateRequest) (*Account, error) {
	return nil, nil
}

func (s *handlerService) Get(context.Context, uuid.UUID, uuid.UUID) (*Account, error) {
	return nil, nil
}

func (s *handlerService) List(_ context.Context, userID uuid.UUID, _ common.Page) ([]Account, int64, error) {
...
func TestListUsesAuthenticatedUserID(t *testing.T) {
	...
	engine.GET("/api/v1/accounts", handler.list)
